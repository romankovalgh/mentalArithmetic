...
(function() {
  var StringToNumber, SummandN2, answerUserInt, answerUserSum, answerUserText, checkAnswerUser, createSummands, expressionExample1, expressionExample2, getRandomInt, outputResult;

  answerUserInt = void 0;

  answerUserText = void 0;

  expressionExample1 = void 0;

  expressionExample2 = void 0;

  getRandomInt = void 0;

  createSummands = void 0;

  checkAnswerUser = void 0;

  StringToNumber = void 0;

  answerUserSum = void 0;
  ...
  getRandomInt = function(min, max) {
    var randomInt;
    return randomInt = min + Math.floor(Math.random() * (max - min + 1));
  };
  ...
  createSummands = function(secondSummand) {
    if (secondSummand == null) {
      secondSummand = 7;
    }
    expressionExample1 = getRandomInt(1, 100);
    return expressionExample2 = secondSummand;
  };
  ...
  answerUserSum = function() {
    ...
    if (userAnswerText === 'e' || userAnswerText === 'end' || userAnswerText === 'у') {
      die();
    }
  ...
  while (true) {
    ...
    if (answerUserText === '2d' || answerUserText === '2в') {
